...
### Previous : optimizer = torch.optim.Adam(model.parameters(), lr=args.lr, weight_decay=1e-4) ## TODO
...
for epoch in range(args.epochs):
    ...
    for batch in train_loader: 
        ...
        with torch.no_grad():
            ...
            ### tokenized_x: (batch_size, fh * fwss) = (batch_size, token) = (32, 64)
        ...
        #但这处代码存在问题
        #因为 tokenized_x_raw 是 LFQ 的原始输出，在形状和内容上可能与你后续的 logits（经过 embedding、HypFormer decoder 得到的 logits）不匹配。
